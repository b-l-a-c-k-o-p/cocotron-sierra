...
[INVALID] google drive link: https://drive.google.com/open?id=0B1o0z0BrwDRURU8xa3dkMF91MnM&resourcekey=0-wUmyMC7jlGxKpxT-b_DxGA
...
latest working (compiling) Version is under macos Mojave with xcode 9.4.1

however the generated macos and windows apps still run with latest macos sequoia (also on apple silicon) and windows 11

so i still use this setup under parallels to update my apps.
